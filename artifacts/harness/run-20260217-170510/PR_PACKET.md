...
Generated: 2026-02-17T17:05:56.552407+00:00
...
| smoke | FAIL | yes | 3.73 |
| pretest_checklist | PASS | yes | 18.99 |
| content_v1_battletest | FAIL | yes | 2.83 |
| playwright | PASS | yes | 20.37 |
...
- `artifacts/harness/run-20260217-170510/screenshots/01-dev-login.png`
- `artifacts/harness/run-20260217-170510/screenshots/02-learning-widget-render.png`
- `artifacts/harness/run-20260217-170510/screenshots/03-floating-panel-render.png`
- `artifacts/harness/run-20260217-170510/screenshots/04-assessment-mobile-responsive.png`
- `artifacts/harness/run-20260217-170510/screenshots/05-learning-mobile-responsive.png`
- `artifacts/harness/run-20260217-170510/screenshots/06-floating-panel-profile-route.png`
- `artifacts/harness/run-20260217-170510/screenshots/07-assessment-dark-theme.png`
