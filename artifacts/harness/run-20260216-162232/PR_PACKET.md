...
Generated: 2026-02-16T16:30:57.535129+00:00
...
| smoke | PASS | yes | 190.3 |
| pretest_checklist | PASS | yes | 236.56 |
| content_v1_battletest | PASS | yes | 49.19 |
| playwright | PASS | yes | 28.26 |
| greptile | SKIPPED | no | 0.04 |
...
- `artifacts/harness/run-20260216-162232/screenshots/01-dev-login.png`
- `artifacts/harness/run-20260216-162232/screenshots/02-learning-widget-render.png`
- `artifacts/harness/run-20260216-162232/screenshots/03-floating-panel-render.png`
- `artifacts/harness/run-20260216-162232/screenshots/04-assessment-mobile-responsive.png`
- `artifacts/harness/run-20260216-162232/screenshots/05-learning-mobile-responsive.png`
- `artifacts/harness/run-20260216-162232/screenshots/06-floating-panel-profile-route.png`
- `artifacts/harness/run-20260216-162232/screenshots/07-assessment-dark-theme.png`
