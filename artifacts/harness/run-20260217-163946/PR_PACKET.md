...
Generated: 2026-02-17T16:41:25.974567+00:00
...
| smoke | FAIL | yes | 7.49 |
| pretest_checklist | PASS | yes | 56.01 |
| content_v1_battletest | FAIL | yes | 3.01 |
| playwright | PASS | yes | 32.74 |
...
- `artifacts/harness/run-20260217-163946/screenshots/01-dev-login.png`
- `artifacts/harness/run-20260217-163946/screenshots/02-learning-widget-render.png`
- `artifacts/harness/run-20260217-163946/screenshots/03-floating-panel-render.png`
- `artifacts/harness/run-20260217-163946/screenshots/04-assessment-mobile-responsive.png`
- `artifacts/harness/run-20260217-163946/screenshots/05-learning-mobile-responsive.png`
- `artifacts/harness/run-20260217-163946/screenshots/06-floating-panel-profile-route.png`
- `artifacts/harness/run-20260217-163946/screenshots/07-assessment-dark-theme.png`
