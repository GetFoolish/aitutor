...
2. A list of new image URLs generated by the Image Generator Agent.
3. (Optional) A list of descriptive texts found here (prompts) from the Descriptive Text Extractor Agent, to be used as alt text.
