...
function FloatingControlPanel({
  ...
  const panelClasses = useMemo(
    () =>
      cn(
        "fixed z-[1000] bg-[#FFFDF5] dark:bg-[#000000] border-[4px] md:border-[4px] border-black dark:border-white rounded-lg md:rounded-xl",
        isCollapsed
    ...
    >
        ...
        >
          {!isCollapsed && (
            <div className="flex items-center gap-1.5 md:gap-2">
              ...
              />
              {assessmentMode && (
                <div className="px-2 py-0.5 bg-[#FF6B6B] border-[4px] border-black text-white text-[8px] md:text-sm font-black uppercase tracking-wide">
                  Assessment
                </div>
              )}
            </div>
          ...
          <button
            ...
            className="w-5 h-5 md:w-6 md:h-6 flex items-center justify-center border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] hover:bg-[#FFD93D] text-black dark:text-white hover:translate-x-0.5 hover:translate-y-0.5 transition-all duration-100"
          >
            {isCollapsed ? (
        ...
        {isCollapsed ? (
          <div className="flex flex-col items-center gap-1.5 md:gap-2">
            <button
              onClick={handleCollapse}
              className="w-12 h-12 md:w-9 md:h-9 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] hover:bg-[#FFD93D] flex items-center justify-center text-black dark:text-white transition-all hover:translate-x-0.5 hover:translate-y-0.5 duration-100 shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] hover:shadow-none"
              title="Expand"
            >
            ...
            <button
              ...
              className={cn(
                "w-12 h-12 md:w-10 md:h-10 border-[4px] border-black flex items-center justify-center transition-all transform active:translate-x-1 active:translate-y-1 relative group font-black",
                connected
                  ? "bg-[#FF6B6B] hover:bg-[#FF6B6B] text-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)]"
                  : "bg-[#4ADE80] hover:bg-[#4ADE80] text-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)]",
              )}
            ...
            <button
              onClick={handleMute}
              className={cn(
                "w-12 h-12 md:w-9 md:h-9 border-[4px] border-black flex items-center justify-center transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 duration-100",
                muted
            ...
            {supportsVideo && cameraEnabled && (
              <button
                ...
                className={cn(
                  "w-12 h-12 md:w-9 md:h-9 border-[4px] border-black dark:border-white flex items-center justify-center transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 duration-100",
                  privacyMode
            ...
            {enableEditingSettings && (
              <SettingsDialog
                ...
                trigger={
                  <button className="w-12 h-12 md:w-9 md:h-9 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] hover:bg-[#FF6B6B] flex items-center justify-center text-black dark:text-white hover:text-white transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 duration-100">
            ...
            <div
              className={cn(
                "w-10 h-8 flex items-center justify-center text-sm font-mono font-black mt-1 transition-colors border-[4px] border-black",
                connected
                  ? "bg-[#FFD93D] text-black"
          ...
          <div className="flex flex-col gap-1.5 md:gap-2">
            <div
              onClick={handleMute}
              className={cn(
                "flex items-center justify-between p-2 md:p-2.5 border-[4px] border-black dark:border-white transition-all duration-100 group cursor-pointer shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] hover:shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:hover:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)]",
                !muted
            ...
            >
              <div className="flex items-center gap-1.5 md:gap-2 min-w-0 flex-1 pr-2 md:pr-3">
                <div
                  className={cn(
                    "flex items-center justify-center w-6 h-6 md:w-7 md:h-7 border-[4px] border-black dark:border-white transition-colors flex-shrink-0",
                    !muted
                      ? "bg-[#C4B5FD] text-black"
                ...
                <div className="flex flex-col min-w-0 flex-1">
                  <span className="text-sm md:text-base font-black text-black dark:text-white uppercase tracking-wide">
                    Microphone
                  </span>
                  <select
                    className="bg-transparent border-none text-sm md:text-base text-black dark:text-white outline-none cursor-pointer w-full max-w-[100px] md:max-w-[120px] truncate p-0 font-bold uppercase pr-4"
              ...
              <button
                ...
                className={cn(
                  "text-sm md:text-base font-black px-2 md:px-3 py-1 md:py-1.5 transition-all border-[4px] border-black dark:border-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none uppercase flex-shrink-0",
                  !muted
                    ? "bg-[#C4B5FD] text-black"
            ...
            {supportsVideo && (
              <div
                onClick={() => onToggleCamera(!cameraEnabled)}
                className={cn(
                  "flex items-center justify-between p-2 md:p-2.5 border-[4px] border-black dark:border-white transition-all duration-100 cursor-pointer shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)]",
                  cameraEnabled
                    ? "bg-[#C4B5FD]"
                    : "bg-[#FFFDF5] dark:bg-[#000000]",
                )}
              >
                <div className="flex items-center gap-1.5 md:gap-2">
                  <div
                    className={cn(
                      "flex items-center justify-center w-6 h-6 md:w-7 md:h-7 border-[4px] border-black dark:border-white transition-colors",
                      cameraEnabled
                        ? "bg-[#FFFDF5] dark:bg-[#000000] text-black dark:text-white"
                        : "bg-[#FFFDF5] dark:bg-[#000000] text-black dark:text-white",
                    )}
                ...
                <button
                  ...
                  className={cn(
                    "text-sm md:text-base font-black px-2 md:px-3 py-1 md:py-1.5 transition-all border-[4px] border-black dark:border-white shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none uppercase",
                    cameraEnabled
                      ? "bg-[#FFFDF5] dark:bg-[#000000] text-black dark:text-white"
                      : "bg-[#C4B5FD] text-black",
                  )}
            ...
            {supportsVideo && (
              ...
              >
                <div className="flex items-center gap-1.5 md:gap-2">
                  <div
                    className={cn(
                      "flex items-center justify-center w-6 h-6 md:w-7 md:h-7 border-[4px] border-black transition-colors",
                      screenEnabled
            ...
            <button
              ...
              className={cn(
                "w-full py-2.5 md:py-3 font-black transition-all transform flex items-center justify-center gap-2 mt-1 border-[4px] md:border-[4px] border-black dark:border-white uppercase text-base md:text-xs",
                connected
                  ? "bg-[#FF6B6B] hover:bg-[#FF6B6B] text-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none cursor-pointer"
                  : checkingBalance
                    ? "bg-gray-300 text-gray-500 cursor-not-allowed opacity-60 shadow-none"
                    : "bg-[#4ADE80] hover:bg-[#4ADE80] text-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none cursor-pointer"
              )}
              title={connected ? "End Session" : "Start Session"}
            >
              {connected ? (
            ...
            <div className="grid grid-cols-4 gap-1.5 md:gap-2 pt-2 md:pt-3 border-t-[2px] border-black dark:border-white">
              {enableEditingSettings && (
                <SettingsDialog
                  className="w-full"
                  trigger={
                    <button className="flex flex-col items-center gap-1 p-1.5 md:p-2 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] hover:bg-[#FF6B6B] text-black dark:text-white hover:text-white transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none group w-full">
                      <div className="p-1 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] group-hover:bg-[#FF6B6B] transition-colors">
              ...
              <button
                onClick={onPaintClick}
                className={cn(
                  "flex flex-col items-center gap-1 p-1.5 md:p-2 border-[4px] border-black dark:border-white transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none group",
                  isPaintActive
                    ? "bg-[#FFD93D] text-black"
              ...
              >
                <div
                  className={cn(
                    "p-1 border-[4px] border-black dark:border-white transition-colors",
                    isPaintActive
                      ? "bg-[#FFFDF5] dark:bg-[#000000] text-black dark:text-white"
              ...
              <button className="flex flex-col items-center gap-1 p-1.5 md:p-2 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] hover:bg-[#C4B5FD] text-black dark:text-white transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none group">
                <div className="p-1 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] group-hover:bg-[#C4B5FD] transition-colors">
        ...
        {sharedMediaOpen && (
          <div
            className={cn(
              "absolute w-[320px] md:w-[360px] h-auto flex flex-col bg-white dark:bg-[#000000] border-[4px] md:border-[4px] border-black dark:border-white rounded-xl md:rounded-2xl shadow-[4px_4px_0_0_rgba(0,0,0,1)] md:shadow-[3px_3px_0_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] md:dark:shadow-[3px_3px_0_0_rgba(255,255,255,0.3)] overflow-hidden z-[1001]",
          ...
          >
            <div className="flex items-center justify-between p-3 md:p-3.5 border-b-[3px] md:border-b-[4px] border-black dark:border-white bg-[#FFE500]">
              <div className="flex items-center gap-2 md:gap-3">
                <div className="p-1.5 md:p-2 border-[4px] md:border-[4px] border-black dark:border-white bg-white dark:bg-[#000000]">
                ...
                <span
                  className={cn(
                    "px-2 md:px-3 py-0.5 md:py-1 text-sm md:text-base font-black uppercase tracking-wider border-[4px] md:border-[4px] border-black dark:border-white",
                    {
              ...
              <button
                onClick={toggleSharedMedia}
                className="w-12 h-12 md:w-9 md:h-9 flex items-center justify-center border-[4px] md:border-[4px] border-black dark:border-white bg-white dark:bg-[#000000] hover:bg-[#FF006E] text-black dark:text-white hover:text-white transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] md:shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] md:dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] hover:shadow-none hover:translate-x-1 hover:translate-y-1"
              >
        ...
        <AlertDialog open={showNoMinutesDialog} onOpenChange={setShowNoMinutesDialog}>
          <AlertDialogContent className="border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.3)]">
            <AlertDialogHeader>
            ...
            <AlertDialogFooter className="gap-2 sm:gap-3 mt-4">
              <AlertDialogCancel className="border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] text-black dark:text-white hover:bg-[#FFD93D] dark:hover:bg-[#FFD93D] hover:text-black font-black uppercase shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none">
                Maybe Later
              </AlertDialogCancel>
              <AlertDialogAction
                onClick={() => {
                ...
                className="border-[4px] border-black dark:border-white bg-[#4ADE80] text-black hover:bg-[#4ADE80] font-black uppercase shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none"
              >
                View Plans
              </AlertDialogAction>
            </AlertDialogFooter>
