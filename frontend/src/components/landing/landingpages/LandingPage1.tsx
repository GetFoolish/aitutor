        ...
        <div className="lp1-container-narrow">
          ...
          <div className="lp1-features-grid">
            <div className="lp1-feature">
              ...
              <p>Adaptive questions generated by Gemini AI, tailored to your level and learning gaps in real time.</p>
            </div>
            <div className="lp1-feature">
              <div className="lp1-feature-icon">
                <Star size={28} strokeWidth={2} />
              </div>
              <h3>10-Question Assessments</h3>
              <p>Quick, focused sessions that pinpoint exactly what you know and what to work on. Results in minutes.</p>
            </div>
            <div className="lp1-feature">
              <div className="lp1-feature-icon">
                <Heart size={28} strokeWidth={2} />
              </div>
              <h3>Any Subject, Any Age</h3>
              <p>Math, Science, English, History — for students ages 5–18. From kindergarten to Grade 12.</p>
            </div>
          </div>
        </div>
      </section>
