...
Generated: 2026-02-17T20:40:32.184663+00:00
...
| --- | --- | --- | --- |
| secret_scan | PASS | yes | 0.24 |
| smoke | FAIL | yes | 2.02 |
| pretest_checklist | PASS | yes | 18.81 |
| content_v1_battletest | FAIL | yes | 5.1 |
| playwright | FAIL | yes | 35.41 |
...
- `artifacts/harness/run-20260217-203930/screenshots/01-dev-login.png`
- `artifacts/harness/run-20260217-203930/screenshots/02-learning-widget-render.png`
- `artifacts/harness/run-20260217-203930/screenshots/04-assessment-mobile-responsive.png`
- `artifacts/harness/run-20260217-203930/screenshots/07-assessment-dark-theme.png`
