...
function FloatingControlPanel({
  ...
  const panelClasses = useMemo(
    () =>
      cn(
        "fixed z-[1000] bg-[#FFFDF5] dark:bg-[#000000] border-[4px] md:border-[3px] border-black dark:border-white rounded-lg md:rounded-xl",
        isCollapsed
    ...
    >
        ...
        >
          {!isCollapsed && (
            <div className="flex items-center gap-1.5 md:gap-2">
              ...
              />
              {assessmentMode && (
                <div className="px-2 py-0.5 bg-[#FF6B6B] border-[4px] border-black text-white text-xs md:text-sm font-black uppercase tracking-wide">
                  Assessment
                </div>
              )}
            </div>
        ...
        {isCollapsed ? (
          <div className="flex flex-col items-center gap-1.5 md:gap-2">
            <button
              onClick={handleCollapse}
              className="w-8 h-8 md:w-9 md:h-9 border-[4px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] hover:bg-[#FFD93D] flex items-center justify-center text-black dark:text-white transition-all hover:translate-x-0.5 hover:translate-y-0.5 duration-100 shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] hover:shadow-none"
              title="Expand"
            >
            ...
            <button
              ...
              className={cn(
                "w-9 h-9 md:w-10 md:h-10 border-[4px] border-black flex items-center justify-center transition-all transform active:translate-x-1 active:translate-y-1 relative group font-black",
                connected
            ...
            <button
              onClick={handleMute}
              className={cn(
                "w-8 h-8 md:w-9 md:h-9 border-[4px] border-black flex items-center justify-center transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 duration-100",
                muted
            ...
            {supportsVideo && cameraEnabled && (
              <button
                ...
                className={cn(
                  "w-8 h-8 md:w-9 md:h-9 border-[4px] border-black dark:border-white flex items-center justify-center transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5 duration-100",
                  privacyMode
            ...
            <div
              className={cn(
                "w-12 h-12 flex items-center justify-center text-sm font-mono font-black mt-1 transition-colors border-[4px] border-black",
                connected
                  ? "bg-[#FFD93D] text-black"
          ...
          <div className="flex flex-col gap-1.5 md:gap-2">
            ...
            <button
              ...
              className={cn(
                "w-full py-2.5 md:py-3 font-black transition-all transform flex items-center justify-center gap-2 mt-1 border-[4px] md:border-[3px] border-black dark:border-white uppercase text-[10px] md:text-xs",
                connected
          ...
          >
            <div className="flex items-center justify-between p-3 md:p-3.5 border-b-[3px] md:border-b-[4px] border-black dark:border-white bg-[#FFE500]">
              <div className="flex items-center gap-2 md:gap-3">
                <div className="p-1.5 md:p-2 border-[4px] md:border-[3px] border-black dark:border-white bg-white dark:bg-[#000000]">
                ...
                <span
                  className={cn(
                    "px-2 md:px-3 py-0.5 md:py-1 text-sm md:text-base font-black uppercase tracking-wider border-[4px] md:border-[3px] border-black dark:border-white",
                    {
              ...
              <button
                onClick={toggleSharedMedia}
                className="w-8 h-8 md:w-9 md:h-9 flex items-center justify-center border-[4px] md:border-[3px] border-black dark:border-white bg-white dark:bg-[#000000] hover:bg-[#FF006E] text-black dark:text-white hover:text-white transition-all shadow-[4px_4px_0_0_rgba(0,0,0,1)] md:shadow-[2px_2px_0_0_rgba(0,0,0,1)] dark:shadow-[1px_1px_0_0_rgba(255,255,255,0.3)] md:dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] hover:shadow-none hover:translate-x-1 hover:translate-y-1"
              >
          ...
          <AlertDialogContent className="border-[3px] border-black dark:border-white bg-[#FFFDF5] dark:bg-[#000000] shadow-[4px_4px_0_0_rgba(0,0,0,1)] dark:shadow-[4px_4px_0_0_rgba(255,255,255,0.3)]">
            ...
            <AlertDialogFooter className="gap-2 sm:gap-3 mt-4">
              ...
              <AlertDialogAction
                ...
                className="border-[4px] border-black dark:border-white bg-[#4ADE80] text-black hover:bg-[#4ADE80] font-black uppercase shadow-[2px_2px_0_0_rgba(0,0,0,1)] dark:shadow-[2px_2px_0_0_rgba(255,255,255,0.3)] active:translate-x-1 active:translate-y-1 active:shadow-none"
              >
                View Plans
              </AlertDialogAction>
            </AlertDialogFooter>
