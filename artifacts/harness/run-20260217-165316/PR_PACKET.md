...
Generated: 2026-02-17T16:54:27.375843+00:00
...
| smoke | FAIL | yes | 10.59 |
| pretest_checklist | PASS | yes | 27.21 |
| content_v1_battletest | FAIL | yes | 7.03 |
| playwright | PASS | yes | 25.79 |
...
- `artifacts/harness/run-20260217-165316/screenshots/01-dev-login.png`
- `artifacts/harness/run-20260217-165316/screenshots/02-learning-widget-render.png`
- `artifacts/harness/run-20260217-165316/screenshots/03-floating-panel-render.png`
- `artifacts/harness/run-20260217-165316/screenshots/04-assessment-mobile-responsive.png`
- `artifacts/harness/run-20260217-165316/screenshots/05-learning-mobile-responsive.png`
- `artifacts/harness/run-20260217-165316/screenshots/06-floating-panel-profile-route.png`
- `artifacts/harness/run-20260217-165316/screenshots/07-assessment-dark-theme.png`
