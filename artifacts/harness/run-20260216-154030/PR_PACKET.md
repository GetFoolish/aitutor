...
Generated: 2026-02-16T15:47:33.354622+00:00
...
| smoke | PASS | yes | 183.97 |
| pretest_checklist | PASS | yes | 159.94 |
| content_v1_battletest | PASS | yes | 56.23 |
| playwright | PASS | yes | 21.98 |
| greptile | PASS | yes | 0.95 |
...
- `artifacts/harness/run-20260216-154030/screenshots/01-dev-login.png`
- `artifacts/harness/run-20260216-154030/screenshots/02-learning-widget-render.png`
- `artifacts/harness/run-20260216-154030/screenshots/03-floating-panel-render.png`
- `artifacts/harness/run-20260216-154030/screenshots/04-assessment-mobile-responsive.png`
- `artifacts/harness/run-20260216-154030/screenshots/05-learning-mobile-responsive.png`
- `artifacts/harness/run-20260216-154030/screenshots/06-floating-panel-profile-route.png`
- `artifacts/harness/run-20260216-154030/screenshots/07-assessment-dark-theme.png`
