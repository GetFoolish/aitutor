...
load_dotenv('.env')
# Use direct IP or different connection params if DNS is failing
# But let's try a very long timeout first
...
for coll_name in collections:
    ...
    try:
        ...
        if not item:
            # Try searching by itemID or questionId in case the _id is different
