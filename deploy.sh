...
gcloud builds submit \
    ...
    --substitutions="_ENV_SUFFIX=${ENV_SUFFIX},_MONGODB_DB_NAME=${MONGODB_DB_NAME},_MONGODB_URI_SECRET=${MONGODB_URI_SECRET},_OPENROUTER_API_KEY_SECRET=${OPENROUTER_API_KEY_SECRET},_GEMINI_API_KEY_SECRET=${GEMINI_API_KEY_SECRET},_JWT_SECRET_SECRET=${JWT_SECRET_SECRET},_GOOGLE_CLIENT_ID_SECRET=${GOOGLE_CLIENT_ID_SECRET},_GOOGLE_CLIENT_SECRET_SECRET=${GOOGLE_CLIENT_SECRET_SECRET},_OBSERVER_API_KEY_SECRET=${OBSERVER_API_KEY_SECRET},_GEMINI_MODEL=${GEMINI_MODEL},_DASH_API_URL=${DASH_API_URL},_SHERLOCKED_API_URL=${SHERLOCKED_API_URL},_TEACHING_ASSISTANT_API_URL=${TEACHING_ASSISTANT_API_URL},_AUTH_SERVICE_URL=${AUTH_SERVICE_URL},_FRONTEND_URL=${FRONTEND_URL},_ALLOWED_ORIGINS=${ALLOWED_ORIGINS},_GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID_PUBLIC}" \
    .
